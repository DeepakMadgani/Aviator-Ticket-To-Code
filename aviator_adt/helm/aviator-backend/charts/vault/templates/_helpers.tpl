...
{{/*
Create the name of the ClusterRole for RBAC
*/}}
{{- define "vault.rbac.clusterRoleName" -}}
{{- if .Values.rbac.clusterRole.name }}
{{- .Values.rbac.clusterRole.name }}
{{- else }}
{{- printf "%s-auth-delegator" (include "vault.fullname" .) }}
{{- end }}
{{- end }}

{{/*
Create the name of the ClusterRoleBinding for RBAC
*/}}
{{- define "vault.rbac.clusterRoleBindingName" -}}
